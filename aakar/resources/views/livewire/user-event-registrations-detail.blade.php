<div>
    ...
    <x-modal id="user-event-registrations-modal" wire:model="showingModal">
            ...
            <div class="modal-body">
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="eventRegistration.event_id"
                            label="Event"
                            wire:model="eventRegistration.event_id"
                        >
                            <option value="null" disabled>Please select the Event</option>
                            @foreach($eventsForSelect as $value => $label)
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.user_event_registrations.inputs.event_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
